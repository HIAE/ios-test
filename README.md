...
### Seja muuuuuito bem vindx ao teste de iOS  do Albert Einstein!
...
Nós queremos que você mostre todas as suas habilidades construindo um app iOS usando Swift (Objective-C não dá mais né migxs?) que consuma a API do [ChuckNorrisAPI](https://api.chucknorris.io/ "ChuckNorrisAPI")
